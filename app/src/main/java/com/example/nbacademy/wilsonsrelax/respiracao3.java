...
public class respiracao3 extends AppCompatActivity {
			...
			Thread thread = new Thread(new Runnable() {
				...
				public void run() {
					...
					if(progress == 0 && progressBar.getProgress()<100)
						setProgressValue(0,progressBar.getProgress() + 10, totalTime + 400);
					else {
						if (progress == 100 && progressBar.getProgress() == 0) {
							setProgressValue(0,progressBar.getProgress() + 10, totalTime + 400);
						} else {
							setProgressValue(100, progressBar.getProgress() - 10, totalTime + 400);
						}
					}
				}
			});
